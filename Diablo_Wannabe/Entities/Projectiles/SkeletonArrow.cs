...
{
    public class SkeletonArrow : IProjectile
    {
        ...
        public SkeletonArrow(Vector2 position, Vector2 direction, Vector2 playerPos)
        {
        ...
        public void Fly(int damage, GameTime gameTime)
        {
            if (this.Exists)
            {
                ...
                if (Map.Player.BoundingBox.Contains(this.Position.ToPoint()))
                {
